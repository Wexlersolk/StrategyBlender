...
input int InpMagicNumber = 707320875;
...
void OnTick()
{
   ...
   if(LongSignal(atr_value))
   {
      ...
      trade.Buy(InpLots, _Symbol, 0.0, sl, tp, "cand_70d732087558_0000_long");
      return;
   }
   ...
   if(ShortSignal(atr_value))
   {
      ...
      trade.Sell(InpLots, _Symbol, 0.0, sl, tp, "cand_70d732087558_0000_short");
   }
}
